...
const SearchTicketBox = () => {
  ...
  return (
    <div className='container md:absolute left-0 right-0 mx-auto px-4 py-6 md:p-6 -bottom-40 my-6 rounded-lg space-y-4 sm:space-y-6 shadow-md w-full bg-white h-fit'>
      ...
      {/* ticket type */}
      <div className='flex items-center justify-evenly sm:justify-center lg:justify-start gap-2 sm:gap-4 font-IRANSansXBold text-shade3 text-sm px-5 child:sm:h-10 child:h-8 child:w-24 child:border child:border-shade1 child:rounded-lg child:transition-all'>
        <button
